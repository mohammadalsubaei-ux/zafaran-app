...
const make_s = (c: Colors) => StyleSheet.create({
  ...
  title:             { fontSize: 18, color: c.text, fontFamily: "Almarai_800ExtraBold" },
  ...
  statusVal:         { fontSize: 15, textAlign: "right", fontFamily: "Almarai_700Bold" },
  statusDesc:        { fontSize: 11, color: c.textSoft, textAlign: "right", fontFamily: "Almarai_400Regular", marginTop: 2 },
  statusChange:      { fontSize: 13, fontFamily: "Almarai_700Bold" },
  ...
  menuBtnText:       { color: c.gold, fontSize: 15, fontFamily: "Almarai_800ExtraBold" },
  ...
  statNum:           { fontSize: 20, color: c.gold, fontFamily: "Almarai_800ExtraBold" },
  ...
  orderId:           { fontSize: 13, color: c.text, fontFamily: "Almarai_700Bold" },
  badge:             { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 50 },
  badgeText:         { fontSize: 11, fontFamily: "Almarai_700Bold" },
  ...
  total:             { fontSize: 16, color: c.gold, fontFamily: "Almarai_800ExtraBold" },
  ...
  btnText:           { color: c.gold, fontSize: 13, fontFamily: "Almarai_700Bold" },
  btnTextRej:        { color: c.danger, fontSize: 13, fontFamily: "Almarai_700Bold" },
  btnTextProp:       { color: c.success, fontSize: 13, fontFamily: "Almarai_700Bold" },
  ...
  modalTitle:        { fontSize: 18, color: c.text, textAlign: "right", marginBottom: 16, fontFamily: "Almarai_800ExtraBold" },
  ...
  statusOptionLabel: { fontSize: 15, textAlign: "right", fontFamily: "Almarai_700Bold", marginBottom: 4 },
  ...
  modalCloseText:    { color: c.danger, fontSize: 14, fontFamily: "Almarai_700Bold" },
