...
const SECTIONS = [
  {
    title: "طبيعة الخدمة",
    body: "زعفران منصة وسيطة تربط العملاء بالمتاجر المنزلية (طبخ بيتي، حلا، قهوة، مخبوزات وسائر التخصصات) ومناديب التوصيل في منطقة القصيم. المنتجات تعدها المتاجر بمطابخها الخاصة، ودور زعفران تنظيم الطلب والدفع والتوصيل وضمان جودة التجربة.",
  },
  {
  ...
  },
  {
    ...
    body: "الأسعار المعروضة تحددها المتاجر، وتضاف رسوم التوصيل حسب المسافة وتظهر بوضوح قبل تأكيد الطلب. بتأكيدك الطلب تلتزم باستلامه ودفع قيمته. أوقات التحضير تقديرية وقد تختلف حسب طبيعة المنتج البيتي وضغط الطلبات.",
  },
  {
  ...
  },
  {
    ...
    body: "تقيد أرباح المتاجر والمناديب بمحافظهم داخل المنصة فور إتمام الطلبات، ويمكن طلب سحبها متى بلغت الحد الأدنى المعلن. تعالج طلبات السحب من الإدارة وتحول للحساب البنكي خلال فترة معقولة.",
  },
  {
