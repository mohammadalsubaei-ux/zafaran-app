...
const s = StyleSheet.create({
  ...
  balanceLabel:  { fontSize: 13, color: "#8A6030", marginBottom: 8, fontWeight: "600" },
  balanceAmount: { fontSize: 52, fontWeight: "900", color: "#F0A500", lineHeight: 60 },
  balanceCurrency: { fontSize: 14, color: "#C97D20", marginTop: 4 },
  section:       { paddingHorizontal: 16, marginBottom: 8 },
  sectionTitle:  { fontSize: 14, fontWeight: "800", color: "#FDF0DC", marginBottom: 12, textAlign: "right" },
  ...
  amountText:    { fontSize: 16, fontWeight: "800", color: "#F0A500" },
  ...
  txRight:       { flex: 1 },
  txDesc:        { fontSize: 13, fontWeight: "700", color: "#FDF0DC", textAlign: "right" },
  txDate:        { fontSize: 11, color: "#5A3A18", textAlign: "right", marginTop: 3 },
  txAmount:      { fontSize: 16, fontWeight: "900", marginLeft: 12 },
  emptyWrap:     { alignItems: "center", marginTop: 30 },
  emptyEmoji:    { fontSize: 48, marginBottom: 12 },
  empty:         { fontSize: 16, fontWeight: "800", color: "#8A6030", textAlign: "center" },
  emptySub:      { fontSize: 13, color: "#5A3A18", textAlign: "center", marginTop: 6 },
});