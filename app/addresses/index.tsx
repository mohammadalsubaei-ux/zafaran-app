...
const make_s = (c: Colors) => StyleSheet.create({
  ...
  back:           { color: c.gold, fontSize: 15, fontFamily: "Almarai_700Bold" },
  ...
  cardLabel:      { fontSize: 15, color: c.text, fontFamily: "Almarai_700Bold" },
  ...
  addBtnText:     { fontSize: 16, color: c.bg, fontFamily: "Almarai_800ExtraBold" },
  ...
  locBtnText:     { color: c.gold, fontSize: 14, fontFamily: "Almarai_700Bold" },
  saveBtn:        { backgroundColor: c.gold, borderRadius: 16, padding: 16, alignItems: "center" },
  saveBtnText:    { fontSize: 16, color: c.bg, fontFamily: "Almarai_800ExtraBold" },
});