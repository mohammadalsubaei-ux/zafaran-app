    ...
    <SafeAreaView style={s.safe}>
      ...
      <View style={s.footer}>
        <TouchableOpacity style={s.btn} onPress={handleAdd}>
          <Text style={s.btnText}>🛍️ {qty > 0 ? "أضف المزيد" : "أضف للسلة"} — {price} ريال</Text>
        </TouchableOpacity>
        {qty > 0 && (
...
const s = StyleSheet.create({
  ...
  inCartText:   { color: "#4CAF50", fontSize: 14, fontWeight: "800" },
  ...
  btnText:      { fontSize: 17, fontWeight: "900", color: "#0E0700" },
  ...
  cartBtnText:  { fontSize: 15, fontWeight: "800", color: "#F0A500" },
});