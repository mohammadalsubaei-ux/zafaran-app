...
const SECTIONS = [
  {
    title: "مقدمة",
    body: "خصوصيتك أمانة عندنا. توضح هذه السياسة كيف يجمع تطبيق زعفران بياناتك وكيف يستخدمها ويحميها عند استخدامك المنصة، سواء كنت عميلاً أو صاحب متجر أو مندوب توصيل. باستخدامك التطبيق فأنت توافق على ما ورد فيها.",
  },
  {
    title: "البيانات التي نجمعها",
    body: "نجمع البيانات التي تزودنا بها عند التسجيل: الاسم ورقم الجوال وكلمة المرور (محفوظة بتشفير لا يمكن عكسه). وعند استخدامك للتطبيق نجمع بيانات طلباتك وعناوين التوصيل التي تضيفها، وموقعك الجغرافي عند تفعيله لغرض حساب رسوم التوصيل وتتبع الطلب. المتاجر والمناديب نجمع منهم إضافة لذلك بيانات نشاطهم: المدينة، المنتجات، سجل الطلبات والأرباح.",
  },
  {
